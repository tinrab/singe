...
use super::super::super::super::{ImagePipeline, template::CrossCorrelationNormToImage};
...
where
    ...
    L: ChannelLayout,
{
    pub fn cross_correlation_full_norm_to_into<D>(
    ...
    pub fn cross_correlation_same_norm_to_into<D>(
        stream_context: &StreamContext,
        source: &ImageView<'_, T, L>,
        template: &ImageView<'_, T, L>,
        destination: &mut ImageViewMut<'_, D, L>,
    ...
    pub fn cross_correlation_valid_norm_to_into<D>(
        stream_context: &StreamContext,
        source: &ImageView<'_, T, L>,
        template: &ImageView<'_, T, L>,
        destination: &mut ImageViewMut<'_, D, L>,
