...
#[path = "filtering_masked_kernel_into_methods.rs"]
mod into_methods;
...
{
    pub fn filter_high_pass_border(
        self,
        source_offset: Point,
        mask_size: MaskSize,
        border_type: BorderType,
    ) -> Result<Self> {
        self.masked_kernel_border_filter(
            source_offset,
            mask_size,
            border_type,
    ...
    fn masked_kernel_border_filter(
        self,
        source_offset: Point,
        mask_size: MaskSize,
        border_type: BorderType,
