...
use super::template::{
    CrossCorrelationNormScaledImage, template_full_size, template_same_size, template_valid_size,
};
use super::{ImageBacking, ImagePipeline};

#[path = "template_cross_correlation_scaled_into_methods.rs"]
mod into_methods;
...
{
    pub fn cross_correlation_full_norm_scaled(
        self,
        template: &ImageView<'_, T, L>,
        scale_factor: i32,
    ) -> Result<Self> {
        self.cross_correlation_scaled(
            template,
            template_full_size,
            scale_factor,
    ...
    pub fn cross_correlation_same_norm_scaled(
        self,
        template: &ImageView<'_, T, L>,
        scale_factor: i32,
    ) -> Result<Self> {
    ...
    pub fn cross_correlation_valid_norm_scaled(
        self,
        template: &ImageView<'_, T, L>,
        scale_factor: i32,
    ) -> Result<Self> {
