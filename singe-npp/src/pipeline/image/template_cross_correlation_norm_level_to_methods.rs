...
use super::template::{
    CrossCorrelationNormLevelToImage, template_full_size, template_same_size, template_valid_size,
};
use super::{ImageBacking, ImagePipeline};

#[path = "template_cross_correlation_norm_level_to_f32_methods.rs"]
mod f32_methods;
#[path = "template_cross_correlation_norm_level_to_into_methods.rs"]
mod into_methods;
...
where
    ...
    L: ChannelLayout,
{
    pub fn cross_correlation_full_norm_level_to<D>(
        self,
    ...
    {
        self.cross_correlation_norm_level_to(
            template,
            template_full_size,
    ...
    pub fn cross_correlation_same_norm_level_to<D>(
        self,
        template: &ImageView<'_, T, L>,
    ) -> Result<ImagePipeline<'a, D, L>>
    where
    ...
    pub fn cross_correlation_valid_norm_level_to<D>(
        self,
        template: &ImageView<'_, T, L>,
    ) -> Result<ImagePipeline<'a, D, L>>
    where
    ...
    fn cross_correlation_norm_level_to<D>(
        self,
        template: &ImageView<'_, T, L>,
