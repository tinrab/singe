...
#[path = "statistics_masked_channel_scalar_norm_l2_methods.rs"]
mod l2_methods;
...
{
    pub fn norm_inf_channel_masked_into(
        ...
        <Self as MaskedChannelScalarStatisticImage<T, C3>>::norm_inf_channel_masked(
            stream_context,
            source,
            mask,
            channel,
    ...
    pub fn norm_l1_channel_masked_into(
        stream_context: &StreamContext,
        source: &ImageView<'_, T, C3>,
        mask: &MaskView<'_>,
        channel: usize,
        ...
        <Self as MaskedChannelScalarStatisticImage<T, C3>>::norm_l1_channel_masked(
            stream_context,
            source,
            mask,
            channel,
    ...
    pub fn norm_inf_channel_masked(
        self,
        mask: &MaskView<'_>,
        channel: usize,
    ...
    pub(super) fn masked_channel_scalar_norm(
        self,
        mask: &MaskView<'_>,
        channel: usize,
        statistic: fn(
