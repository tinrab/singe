...
fn main() -> Result<()> {
    ...
    singe_core::assert_complex_close!(result[0], Complex32::new(-28.78, 26.90), 1.0e-3);
    singe_core::assert_complex_close!(result[1], Complex32::new(0.0, 0.0), 1.0e-3);
    singe_core::assert_complex_close!(result[2], Complex32::new(-43.18, 40.58), 1.0e-3);
    singe_core::assert_complex_close!(result[3], Complex32::new(-71.98, 68.66), 1.0e-3);
