...
mod kernels {
    ...
    #[cutile::entry()]
    pub fn softmax_f64<const BM: i32, const BN: i32>(
        out: &mut Tensor<f64, { [BM, BN] }>,
        input: &Tensor<f64, { [-1, -1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn log_softmax_f64<const BM: i32, const BN: i32>(
        out: &mut Tensor<f64, { [BM, BN] }>,
        input: &Tensor<f64, { [-1, -1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn softmin_f64<const BM: i32, const BN: i32>(
        out: &mut Tensor<f64, { [BM, BN] }>,
        input: &Tensor<f64, { [-1, -1] }>,
    ) {
...
pub use crate::cuda::cutile::kernel::f64::utility::softmax_lse_f64;
pub use kernels::*;
