...
mod kernels {
    ...
    pub fn fma_f64<const B: i32>(
        ...
        let lhs_tile: Tile<f64, { [B] }> = load_tile_like(lhs, out);
        let rhs_tile: Tile<f64, { [B] }> = load_tile_like(rhs, out);
        let acc_tile: Tile<f64, { [B] }> = load_tile_like(acc, out);
        out.store(fma(
            lhs_tile,
            rhs_tile,
            acc_tile,
    ...
    #[cutile::entry()]
    pub fn maximum_f64<const B: i32>(
        out: &mut Tensor<f64, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn minimum_f64<const B: i32>(
        out: &mut Tensor<f64, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn squared_difference_f64<const B: i32>(
        out: &mut Tensor<f64, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn logaddexp_f64<const B: i32>(
        out: &mut Tensor<f64, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn not_equal_f64<const B: i32>(
        out: &mut Tensor<f64, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn less_equal_f64<const B: i32>(
        out: &mut Tensor<f64, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn greater_f64<const B: i32>(
        out: &mut Tensor<f64, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn greater_equal_f64<const B: i32>(
        out: &mut Tensor<f64, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn equal_bool_f64<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn not_equal_bool_f64<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn less_bool_f64<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn less_equal_bool_f64<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn greater_bool_f64<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn greater_equal_bool_f64<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        lhs: &Tensor<f64, { [-1] }>,
        rhs: &Tensor<f64, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn where_f64<const B: i32>(
        out: &mut Tensor<f64, { [B] }>,
        condition: &Tensor<f64, { [-1] }>,
        x: &Tensor<f64, { [-1] }>,
        y: &Tensor<f64, { [-1] }>,
    ) {
        let condition_tile: Tile<f64, { [B] }> = load_tile_like(condition, out);
        let x_tile: Tile<f64, { [B] }> = load_tile_like(x, out);
        let y_tile: Tile<f64, { [B] }> = load_tile_like(y, out);
        let zero = constant(0.0f64, out.shape());
        let mask = cmpf(
            condition_tile,
            zero,
    ...
    #[cutile::entry()]
    pub fn where_bool_f64<const B: i32>(
        out: &mut Tensor<f64, { [B] }>,
    ...
    #[cutile::entry()]
    pub fn masked_fill_f64<const B: i32>(
        out: &mut Tensor<f64, { [B] }>,
        input: &Tensor<f64, { [-1] }>,
        mask: &Tensor<u8, { [-1] }>,
        value: f64,
