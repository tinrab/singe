...
mod kernels {
    ...
    #[cutile::entry()]
    pub fn neg_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<0i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn abs_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<1i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn sqrt_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<2i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn exp_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<3i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn exp2_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<30i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn log_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<4i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn log2_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<31i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn log10_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<32i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn sin_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<5i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn cos_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<6i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn tan_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<7i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn sinh_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<8i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn cosh_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<9i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn tanh_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<10i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn asin_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<11i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn acos_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<12i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn atan_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<13i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn ceil_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<14i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn floor_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<15i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn trunc_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<16i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn frac_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<42i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn reciprocal_f16<const B: i32>(
        out: &mut Tensor<f16, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn square_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<18i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn rsqrt_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<19i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn cbrt_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<33i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn asinh_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<20i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn acosh_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<21i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn atanh_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<22i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn sign_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<27i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn nan_to_num_f16<const B: i32>(
        out: &mut Tensor<f16, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
        nan: f16,
        posinf: f16,
    ...
    #[cutile::entry()]
    pub fn log1p_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<28i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn expm1_f16<const B: i32>(out: &mut Tensor<f16, { [B] }>, input: &Tensor<f16, { [-1] }>) {
        unary_store::<29i32, B>(out, input);
    }
    #[cutile::entry()]
    pub fn deg2rad_f16<const B: i32>(
        out: &mut Tensor<f16, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn rad2deg_f16<const B: i32>(
        out: &mut Tensor<f16, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn is_nan_bool_f16<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn is_inf_bool_f16<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn is_pos_inf_bool_f16<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn is_neg_inf_bool_f16<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn is_finite_bool_f16<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn is_normal_bool_f16<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn is_subnormal_bool_f16<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn is_zero_bool_f16<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn is_nonzero_bool_f16<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn is_positive_bool_f16<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
    ...
    #[cutile::entry()]
    pub fn is_negative_bool_f16<const B: i32>(
        out: &mut Tensor<u8, { [B] }>,
        input: &Tensor<f16, { [-1] }>,
    ) {
