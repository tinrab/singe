...
mod kernels {
    ...
    #[cutile::entry()]
    pub unsafe fn fmha_decode_splitk_f32_hd4(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
    ...
    #[cutile::entry()]
    pub unsafe fn fmha_decode_splitk_f32_hd8(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
    ...
    #[cutile::entry()]
    pub unsafe fn fmha_decode_splitk_f32_hd16(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
    ...
    #[cutile::entry()]
    pub unsafe fn fmha_decode_splitk_f32_hd32(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
    ...
    #[cutile::entry()]
    pub unsafe fn fmha_decode_splitk_f32_hd64(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_f32_hd4(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
        ...
        softcapped_window_decode_splitk_f32::<4>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_f32_hd8(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
        ...
        softcapped_window_decode_splitk_f32::<8>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_f32_hd16(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
        ...
        softcapped_window_decode_splitk_f32::<16>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_f32_hd32(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
        ...
        softcapped_window_decode_splitk_f32::<32>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_f32_hd64(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
        ...
        softcapped_window_decode_splitk_f32::<64>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_f16_hd4(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f16,
        key: *mut f16,
        ...
        softcapped_window_decode_splitk_f16::<4>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_f16_hd8(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f16,
        key: *mut f16,
        ...
        softcapped_window_decode_splitk_f16::<8>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_f16_hd16(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f16,
        key: *mut f16,
        ...
        softcapped_window_decode_splitk_f16::<16>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_f16_hd32(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f16,
        key: *mut f16,
        ...
        softcapped_window_decode_splitk_f16::<32>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_f16_hd64(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f16,
        key: *mut f16,
        ...
        softcapped_window_decode_splitk_f16::<64>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_bf16_hd4(
        out: *mut f32,
        lse: *mut f32,
        query: *mut bf16,
        key: *mut bf16,
        ...
        softcapped_window_decode_splitk_bf16::<4>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_bf16_hd8(
        out: *mut f32,
        lse: *mut f32,
        query: *mut bf16,
        key: *mut bf16,
        ...
        softcapped_window_decode_splitk_bf16::<8>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_bf16_hd16(
        out: *mut f32,
        lse: *mut f32,
        query: *mut bf16,
        key: *mut bf16,
        ...
        softcapped_window_decode_splitk_bf16::<16>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_bf16_hd32(
        out: *mut f32,
        lse: *mut f32,
        query: *mut bf16,
        key: *mut bf16,
        ...
        softcapped_window_decode_splitk_bf16::<32>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn softcapped_window_decode_splitk_bf16_hd64(
        out: *mut f32,
        lse: *mut f32,
        query: *mut bf16,
        key: *mut bf16,
        ...
        softcapped_window_decode_splitk_bf16::<64>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn attention_sink_decode_splitk_f32_hd4(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
        ...
        attention_sink_decode_splitk_f32::<4>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn attention_sink_decode_splitk_f32_hd8(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
        ...
        attention_sink_decode_splitk_f32::<8>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn attention_sink_decode_splitk_f32_hd16(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
        ...
        attention_sink_decode_splitk_f32::<16>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn attention_sink_decode_splitk_f32_hd32(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
        ...
        attention_sink_decode_splitk_f32::<32>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn attention_sink_decode_splitk_f32_hd64(
        out: *mut f32,
        lse: *mut f32,
        query: *mut f32,
        key: *mut f32,
        ...
        attention_sink_decode_splitk_f32::<64>(
            out,
            lse,
            query,
            key,
    ...
    #[cutile::entry()]
    pub unsafe fn splitk_reduce_f32(
        out: *mut f32,
        attn_splitk: *mut f32,
        lse_splitk: *mut f32,
        _batch: i32,
        ...
        // Reduce one scalar from each split-K partial output.
        // The flat output index decodes to batch/head/dim.
        // Each split contributes an attention value plus an LSE for the same row.
        ...
        let lse_batch_base = batch_index * broadcast_scalar(lse_batch_stride, tile_shape);
        let attn_batch_base = batch_index * broadcast_scalar(attn_batch_stride, tile_shape);

        // Find max LSE across splits before exponentiating.
        // Partial rows from different KV chunks can then be combined with stable softmax algebra.
        let mut max_lse = constant(-1.0e20f32, tile_shape);
        for split in 0i32..splits {
            let lse_offsets = lse_batch_base
                + head * broadcast_scalar(lse_head_stride, tile_shape)
                + broadcast_scalar(split, tile_shape);
            let lse = load_vector(lse_splitk, lse_offsets, valid, -1.0e20f32);
            max_lse = select(
                valid & cmpf(lse, max_lse, predicate::GreaterThan, cmp_ordering::Ordered),
                lse,
                max_lse,
            );
        }
        ...
        // Reweight each split's partial output by exp(lse_split - max_lse).
        // Normalize by the sum of those weights.
        for split in 0i32..splits {
            let lse_offsets = lse_batch_base
                + head * broadcast_scalar(lse_head_stride, tile_shape)
                + broadcast_scalar(split, tile_shape);
            let lse = load_vector(lse_splitk, lse_offsets, valid, -1.0e20f32);
            let weight = exp(lse - max_lse);
            let zero: Tile<f32, { [128] }> = constant(0.0f32, tile_shape);
            let weight = select(valid, weight, zero);
            denom = denom + weight;
            let attn_offsets = attn_batch_base
                + head * broadcast_scalar(attn_head_stride, tile_shape)
                + broadcast_scalar(split * attn_split_stride, tile_shape)
                + dim;
            let partial = load_vector(attn_splitk, attn_offsets, valid, 0.0f32);
            sum = sum + weight * partial;
        }
