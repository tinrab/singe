...
mod kernels {
    ...
    #[cutile::entry()]
    pub unsafe fn attention_sink_prefill_f32_hd4(
        out: *mut f32,
        query: *mut f32,
        key: *mut f32,
        value: *mut f32,
    ...
    #[cutile::entry()]
    pub unsafe fn attention_sink_prefill_f32_hd8(
        out: *mut f32,
        query: *mut f32,
        key: *mut f32,
        value: *mut f32,
    ...
    #[cutile::entry()]
    pub unsafe fn attention_sink_prefill_f32_hd16(
        out: *mut f32,
        query: *mut f32,
        key: *mut f32,
        value: *mut f32,
    ...
    #[cutile::entry()]
    pub unsafe fn attention_sink_prefill_f32_hd32(
        out: *mut f32,
        query: *mut f32,
        key: *mut f32,
        value: *mut f32,
    ...
    #[cutile::entry()]
    pub unsafe fn attention_sink_prefill_f32_hd64(
        out: *mut f32,
        query: *mut f32,
        key: *mut f32,
        value: *mut f32,
    ...
    fn sliding_window_attention_f32<const HEAD_DIM: i32, const WINDOW: i32>(
        ...
        // One lane owns one output scalar.
        // Absolute query positions keep sink/window semantics relative to the KV cache position.
        // They are not just relative to the local query tile.
    ...
    fn attention_sink_prefill_f32<const HEAD_DIM: i32>(
        ...
        // A zero window keeps full history.
        // Otherwise the ordinary K/V pass only sees the trailing window ending at query_pos.
        ...
        // The learned sink is an extra logit in the softmax.
        // It affects the max and denominator, but contributes no V vector to the numerator.
        ...
        // Seed the denominator with the sink probability.
        // Ordinary key probabilities and weighted values are accumulated afterwards.
