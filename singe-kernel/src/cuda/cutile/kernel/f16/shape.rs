...
mod kernels {
    ...
    #[cutile::entry()]
    pub unsafe fn copy_f16(out: *mut f16, input: *mut f16, len: i32) {
    ...
    #[cutile::entry()]
    pub unsafe fn transpose_2d_f16(out: *mut f16, input: *mut f16, rows: i32, cols: i32, len: i32) {
        let pid: (i32, i32, i32) = get_tile_block_id();
        let tile_shape = const_shape![128];
        let offsets: Tile<i32, { [128] }> =
            iota(tile_shape) + broadcast_scalar(pid.0 * 128i32, tile_shape);
        ...
        let input_base: PointerTile<*mut f16, { [1] }> = input_base.reshape(const_shape![1]);
        let input_ptrs: PointerTile<*mut f16, { [128] }> = input_base.broadcast(tile_shape);
        let input_ptrs: PointerTile<*mut f16, { [128] }> = input_ptrs.offset_tile(input_offsets);
        let values: (Tile<f16, { [128] }>, Token) = load_ptr_tko(
            input_ptrs,
            ordering::Weak,
            None::<scope::TileBlock>,
    ...
    #[cutile::entry()]
    pub unsafe fn transpose_last2_rank3_f16(
        out: *mut f16,
        input: *mut f16,
        _batch: i32,
        rows: i32,
    ...
    #[cutile::entry()]
    pub unsafe fn transpose_last2_rank4_f16(
        out: *mut f16,
        input: *mut f16,
        _dim0: i32,
        dim1: i32,
    ...
    #[cutile::entry()]
    pub unsafe fn materialize_rank2_f16(
        out: *mut f16,
        input: *mut f16,
        _dim0: i32,
        dim1: i32,
    ...
    pub unsafe fn slice_rank2_f16(
        ...
        let input_base: PointerTile<*mut f16, { [1] }> = input_base.reshape(const_shape![1]);
        let input_ptrs: PointerTile<*mut f16, { [128] }> = input_base.broadcast(tile_shape);
        let input_ptrs: PointerTile<*mut f16, { [128] }> = input_ptrs.offset_tile(source_offsets);
    ...
    #[cutile::entry()]
    pub unsafe fn materialize_rank3_f16(
        out: *mut f16,
        input: *mut f16,
        _dim0: i32,
        dim1: i32,
    ...
    #[cutile::entry()]
    pub unsafe fn materialize_rank4_f16(
        out: *mut f16,
        input: *mut f16,
        _dim0: i32,
        dim1: i32,
    ...
    unsafe fn concat_rank2_f16_impl<const AXIS: i32>(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        _output_dim0: i32,
        ...
        let lhs_base: PointerTile<*mut f16, { [] }> = pointer_to_tile(lhs);
        let lhs_base: PointerTile<*mut f16, { [1] }> = lhs_base.reshape(const_shape![1]);
        let lhs_ptrs: PointerTile<*mut f16, { [128] }> = lhs_base.broadcast(tile_shape);
        let lhs_ptrs: PointerTile<*mut f16, { [128] }> = lhs_ptrs.offset_tile(lhs_offsets);
        let lhs_result: (Tile<f16, { [128] }>, Token) = load_ptr_tko(
            lhs_ptrs,
            ordering::Weak,
            None::<scope::TileBlock>,
            Some(lhs_mask),
        ...
        let rhs_base: PointerTile<*mut f16, { [] }> = pointer_to_tile(rhs);
        let rhs_base: PointerTile<*mut f16, { [1] }> = rhs_base.reshape(const_shape![1]);
        let rhs_ptrs: PointerTile<*mut f16, { [128] }> = rhs_base.broadcast(tile_shape);
        let rhs_ptrs: PointerTile<*mut f16, { [128] }> = rhs_ptrs.offset_tile(rhs_offsets);
        let rhs_result: (Tile<f16, { [128] }>, Token) = load_ptr_tko(
            rhs_ptrs,
            ordering::Weak,
            None::<scope::TileBlock>,
            Some(rhs_mask),
    ...
    unsafe fn concat_rank3_f16_impl<const AXIS: i32>(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        _output_dim0: i32,
    ...
    pub unsafe fn concat_rank2_f16_axis0(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        output_dim0: i32,
    ...
    #[cutile::entry()]
    #[allow(unsafe_op_in_unsafe_fn)]
    pub unsafe fn concat_rank2_f16_axis1(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        output_dim0: i32,
    ...
    #[cutile::entry()]
    #[allow(unsafe_op_in_unsafe_fn)]
    pub unsafe fn concat_rank3_f16_axis0(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        output_dim0: i32,
    ...
    #[cutile::entry()]
    #[allow(unsafe_op_in_unsafe_fn)]
    pub unsafe fn concat_rank3_f16_axis1(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        output_dim0: i32,
    ...
    #[cutile::entry()]
    #[allow(unsafe_op_in_unsafe_fn)]
    pub unsafe fn concat_rank3_f16_axis2(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        output_dim0: i32,
    ...
    unsafe fn concat_rank4_f16_impl<const AXIS: i32>(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        _output_dim0: i32,
    ...
    #[cutile::entry()]
    pub unsafe fn concat_rank4_f16_axis0(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        output_dim0: i32,
    ...
    #[cutile::entry()]
    pub unsafe fn concat_rank4_f16_axis1(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        output_dim0: i32,
    ...
    #[cutile::entry()]
    pub unsafe fn concat_rank4_f16_axis2(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        output_dim0: i32,
    ...
    #[cutile::entry()]
    pub unsafe fn concat_rank4_f16_axis3(
        out: *mut f16,
        lhs: *mut f16,
        rhs: *mut f16,
        output_dim0: i32,
    ...
    #[cutile::entry()]
    pub unsafe fn repeat_kv_rank4_f16(
        out: *mut f16,
        input: *mut f16,
        _output_dim0: i32,
        output_dim1: i32,
