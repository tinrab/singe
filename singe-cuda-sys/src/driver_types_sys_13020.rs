...
pub struct cudaAccessPolicyWindow {
    ...
    pub hitRatio: f32,
    /// [CUaccessProperty](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-driver-api/group__CUDA__TYPES.html#group__CUDA__TYPES_1gbf4806140e86865b45fc144941a6ced5) set for hit.
    pub hitProp: cudaAccessProperty,
    /// [CUaccessProperty](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-driver-api/group__CUDA__TYPES.html#group__CUDA__TYPES_1gbf4806140e86865b45fc144941a6ced5) set for miss. Must be either NORMAL or STREAMING.
...
/// Cluster scheduling policies. These may be passed to [cudaFuncSetAttribute](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/high-level-api.html#group__CUDART__HIGHLEVEL_1g61085e9f04656b92573af16072bbc78d "\[C++ API\] Set attributes for a given function").
#[repr(u32)]
#[derive(
    Debug,
    Copy,
...
pub struct cudaFuncAttributes {
    ...
    /// See [cudaFuncSetAttribute](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/group__CUDART__HIGHLEVEL.html#group__CUDART__HIGHLEVEL_1g61085e9f04656b92573af16072bbc78d "\[C++ API\] Set attributes for a given function").
    pub requiredClusterWidth: ::core::ffi::c_int,
    pub requiredClusterHeight: ::core::ffi::c_int,
    pub requiredClusterDepth: ::core::ffi::c_int,
    /// The block scheduling policy of a function. See [cudaFuncSetAttribute](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/group__CUDART__HIGHLEVEL.html#group__CUDART__HIGHLEVEL_1g61085e9f04656b92573af16072bbc78d "\[C++ API\] Set attributes for a given function").
    ...
    ///
    /// The specific hardware unit may support higher cluster sizes that’s not guaranteed to be portable. See [cudaFuncSetAttribute](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/group__CUDART__HIGHLEVEL.html#group__CUDART__HIGHLEVEL_1g61085e9f04656b92573af16072bbc78d "\[C++ API\] Set attributes for a given function").
...
pub struct cudaDeviceProp {
    ...
    /// Device supports launching cooperative kernels via [cudaLaunchCooperativeKernel](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/group__CUDART__HIGHLEVEL.html#group__CUDART__HIGHLEVEL_1g7c4cb6c44a6c4608da36c44374499b31 "Launches a device function.")
    ...
    /// The maximum value of [cudaAccessPolicyWindow::num_bytes](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/structcudaAccessPolicyWindow.html#structcudaAccessPolicyWindow_1bbd68021cb5c3cb1928bee0a2941eb24).
...
///
/// Domain ID range is available through [cudaDevAttrMemSyncDomainCount](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/group__CUDART__TYPES.html#group__CUDART__TYPES_1gg49e2f8c2c0bd6fe264f2fc970912e5cd82ae431cc82ee71d008b4e8e9cac06ab).
pub type cudaLaunchMemSyncDomainMap = cudaLaunchMemSyncDomainMap_st;
/// Enum for defining applicability of portable cluster size, used with [cudaLaunchKernelEx](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/high-level-api.html#group__CUDART__HIGHLEVEL_1g81f2b11c6726c7b2f3fc54fc718eaf1c "Launches a CUDA function with launch-time configuration.")
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
...
/// Shared memory related attributes for use with [cuLaunchKernelEx](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-driver-api/group__CUDA__EXEC.html#group__CUDA__EXEC_1gb9c891eb6bb8f4089758e64c9c976db9).
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialOrd, Ord, PartialEq, Eq)]
...
pub enum cudaLaunchAttributeID {
    ...
    /// Valid for streams, graph nodes, launches. See [cudaLaunchAttributeValue::accessPolicyWindow](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_12651ad62e74da106b5e84b2e269e3d2f).
    cudaLaunchAttributeAccessPolicyWindow = 1,
    /// Valid for graph nodes, launches. See [cudaLaunchAttributeValue::cooperative](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_165547cda37105f05546238637fef02d4).
    cudaLaunchAttributeCooperative = 2,
    /// Valid for streams. See [cudaLaunchAttributeValue::syncPolicy](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_1f1c0a1fba8d619e14a27e1a5ffe8eb4e).
    cudaLaunchAttributeSynchronizationPolicy = 3,
    /// Valid for graph nodes, launches. See [cudaLaunchAttributeValue::clusterDim](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_1874ddc728430198e4d36b376a09a2390).
    cudaLaunchAttributeClusterDimension = 4,
    /// Valid for graph nodes, launches. See [cudaLaunchAttributeValue::clusterSchedulingPolicyPreference](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_122bc4df8c928315c4d1a519d5bb7c200).
    ...
    /// Valid for launches. Set [cudaLaunchAttributeValue::programmaticEvent](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_1c4994840dcc67e4fc568a0b68b881830) to record the event. Event recorded through this launch attribute is guaranteed to only trigger after all block in the associated
    ...
    /// Valid for streams, graph nodes, launches. See [cudaLaunchAttributeValue::priority](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_1fbb47c87ab6783ea8bf2740de62e0698).
    cudaLaunchAttributePriority = 8,
    /// Valid for streams, graph nodes, launches. See [cudaLaunchAttributeValue::memSyncDomainMap](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_11eac2ba78a074529a8f8f22a50cfe6f8).
    cudaLaunchAttributeMemSyncDomainMap = 9,
    /// Valid for streams, graph nodes, launches. See [cudaLaunchAttributeValue::memSyncDomain](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_188c32c6eab183c58133c77a6634a2f48).
    cudaLaunchAttributeMemSyncDomain = 10,
    /// Valid for graph nodes and launches. Set [cudaLaunchAttributeValue::preferredClusterDim](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_17862864bbc2343700bae285345d188ca) to allow the kernel launch to specify a preferred substitute cluster dimension. Blocks may be grouped according to either
    ...
    /// Valid for launches. Set [cudaLaunchAttributeValue::launchCompletionEvent](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_1263ce1e0ff682dedbabc39ddf0fcbd93) to record the event.
    ...
    /// uploaded with [cuGraphUpload](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-driver-api/group__CUDA__GRAPH.html#group__CUDA__GRAPH_1ga7eb9849e6e4604864a482b38f25be48) before it is launched. For such a graph, if host-side executable graph updates are made to the device-updatable nodes, the
    ...
    /// Valid values for [cudaLaunchAttributeValue::nvlinkUtilCentricScheduling](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_110531ffcea7ecf81f2ec785f1eeeeb48) are 0 (disabled) and 1 (enabled).
...
pub struct cudaLaunchAttributeValue {
    ...
    ///   of the x field of [cudaLaunchAttributeValue::clusterDim](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_1874ddc728430198e4d36b376a09a2390).
    /// * y - The Y dimension of the preferred cluster, in blocks. Must be a divisor of the grid Y dimension, and must be a multiple
    ///   of the y field of [cudaLaunchAttributeValue::clusterDim](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_1874ddc728430198e4d36b376a09a2390).
    /// * z - The Z dimension of the preferred cluster, in blocks. Must be equal to the z field of [cudaLaunchAttributeValue::clusterDim](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/unioncudaLaunchAttributeValue.html#unioncudaLaunchAttributeValue_1874ddc728430198e4d36b376a09a2390).
...
pub struct cudaLaunchConfig_st {
    ...
    /// List of attributes; nullable if [cudaLaunchConfig_t::numAttrs](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/structcudaLaunchConfig__t.html#structcudaLaunchConfig__t_17a2f01ab7e1e959017ce1c769f568841) == 0.
    pub attrs: *mut cudaLaunchAttribute,
    /// Number of attributes populated in [cudaLaunchConfig_t::attrs](https://docs.nvidia.com/cuda/archive/13.2.0/cuda-runtime-api/structcudaLaunchConfig__t.html#structcudaLaunchConfig__t_16c9c2735da285f0dd11f92c2c2baecf8).
